                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <a href="kategori_buku.php" class="btn btn-info btn-sm"><i class="fas fa-layer-group"></i> Tambahkan Buku ke dalam Kategori</a>
                            <button class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal-tambahKT"><i class="fas fa-plus"> Tambah Kategori</i></button>
                        ...
                        <table class="table table-bordered" id="example1">
                            <thead>
                                <tr class="text-center text-bold bg-info">
                                    ...
                                    <td style="width: 120px;">ID Kategori</td>
                                    <td>Kategori</td>
                                    <td>Aksi</td>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                if (isset($_POST['search'])) {
                                    ...
                                    $member = mysqli_query($koneksi, "SELECT * FROM kategoribuku WHERE
                                    NamaKategori LIKE '%$keyword%' OR
                                    KategoriID LIKE '%$keyword%'
                                    ");
                                } else {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="width: 200px;">
                                            <button class="btn btn-warning" data-toggle="modal" data-target="#modal-edit<?= $data['KategoriID']; ?>"><i class="fas fa-edit"></i> Edit </button>
                                            <button class="btn btn-danger" data-toggle="modal" data-target="#modal-hapus<?= $data['KategoriID']; ?>"><i class="fas fa-trash"></i> Hapus </button>
                                        </td>
                                    </tr>

                                    <div class="modal fade" id="modal-hapus<?= $data['KategoriID']; ?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="">
                                                    <div class="modal-body">
                                                        <p>Apakah anda yakin akan menghapus Kategori <b><?= $data['NamaKategori']; ?></b> ini ... ?</p>
                                                    </div>
                                                    <div class="modal-footer justify-content-between">
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
                                                        <a href="hapus_kategori.php?id=<?= $data['KategoriID']; ?>" class="btn btn-primary">Hapus</a>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal fade" id="modal-edit<?= $data['KategoriID']; ?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                            ...
                                            <form action="simpan_kategori.php" method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="id_kt" class="form-control" placeholder="Masukkan ID Kategori" required>
                                                    </div>
                                                </div>
                                                <div class="modal-footer justify-content-between">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
