        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="alert alert-info">
                        <h6>Selamat Datang <b><?php echo $_SESSION['role'], ' - ',  $_SESSION['NamaLengkap'] ?></b> Di Halaman Admin<b> Perpus Digital </b>!</h6>
                    </div>
                </div>
                <!-- /.col-md-6 -->
            </div>
            ...
            <div class="mt-4 p-3">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="cardImg">
                            <a href="petugas/petugas.php">
                                <img src="../assets/dashboardCardMember/petugas.png" alt="daftar buku" style="max-width: 100%;" width="600px">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="cardImg">
                            <a href="kategori/kategori.php">
                                <img src="../assets/dashboardCardMember/kategori.png" alt="daftar buku" style="max-width: 100%;" width="600px">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="cardImg">
                            <a href="denda/pengelolaanDenda.php">
                                <img src="../assets/dashboardCardMember/denda1.png" alt="daftar buku" style="max-width: 100%;" width="600px">
                            </a>
                        </div>
                    </div>
