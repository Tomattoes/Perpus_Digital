        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h6 class="card-title">Selamat Datang <b><?php echo $_SESSION['role'], ' - ',  $_SESSION['NamaLengkap'] ?></b> Di Halaman User<b> Perpus Digital </b>!</h6>
                        </div>
                    </div>
                </div>
                <!-- /.col-md-6 -->
            ...
            <div class="mt-4 p-3">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="cardImg">
                            <a href="favorit/favorit.php">
                                <img src="../assets/dashboardCardMember/favorit.png" alt="daftar buku" style="max-width: 100%;" width="600px">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
