                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                if (isset($_POST['search'])) {
                                    ...
                                    WHERE p.UserID=u.UserID AND p.BukuID=b.BukuID AND kt.KategoriID=kb.KategoriID AND kt.BukuID=b.BukuID AND
                                    ...
                                    $member = mysqli_query($koneksi, "SELECT * 
                                    FROM peminjaman p, user u, buku b, kategoribuku_relasi kt, kategoribuku kb
                                    WHERE p.UserID=u.UserID AND p.BukuID=b.BukuID AND kt.KategoriID=kb.KategoriID AND kt.BukuID=b.BukuID AND  u.UserID='$id' AND StatusPeminjaman='dipinjam' ORDER BY PeminjamanID DESC");
                                }
                                $no = 1;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="width: 155px;">
                                            <a href="peminjamanBuku.php" onclick="return confirm('Temui Petugas Di Kasir Untuk Mengembalikn Buku!')" class="btn btn-success"><i class="fas fa-backward"></i> Kembalikan</a>
                                        </td>
                                    </tr>
                                <?php } ?>
