                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a class="btn btn-danger btn-sm" href="peminjamanBuku.php"><i class="fas fa-arrow-left"> Back</i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                if (isset($_POST['search'])) {
                                    ...
                                    $member = mysqli_query($koneksi, "SELECT *  FROM kategoribuku_relasi INNER JOIN kategoribuku ON kategoribuku_relasi.KategoriID = kategoribuku.KategoriID INNER JOIN buku ON kategoribuku_relasi.BukuID = buku.BukuID WHERE
                                    ...
                                    $member = mysqli_query($koneksi, "SELECT *  FROM kategoribuku_relasi INNER JOIN kategoribuku ON kategoribuku_relasi.KategoriID = kategoribuku.KategoriID INNER JOIN buku ON kategoribuku_relasi.BukuID = buku.BukuID");
                                }
                                $no = 1;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php if ($data['stok'] == 0) {
                                            ...
                                            <a href="pilihMember.php?id=<?= $data['BukuID']; ?>" class="btn btn-info"><i class="fas fa-book"></i> Pinjam </a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
