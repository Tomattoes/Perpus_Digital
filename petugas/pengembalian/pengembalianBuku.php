                            ...
                            ?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="date" class="form-control" name="tgl_pengembalian" id="tgl_pengembalian" value="<?= $item["TanggalPengembalian"]; ?>" oninput="hitungDenda()" readonly>
                                    </div>
                                    <div class="col-4">
                                        <label for="exampleFormControlInput1" class="form-label">Tanggal Pengembalian Buku</label>
                                        <input type="date" class="form-control" name="buku_kembali" id="buku_kembali" value="<?php echo date('Y-m-d'); ?>" oninput="hitungDenda()" readonly> <!--readonly-->
                                    </div>
                                </div>
                            <?php } ?>
