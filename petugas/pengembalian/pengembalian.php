                            ...
                            <tbody>
                                ...
                                if (isset($_POST['search'])) {
                                   ...
                                   NamaLengkap LIKE '%$keyword%' OR
                                    ...
                                    $member = mysqli_query($koneksi, "SELECT * FROM peminjaman INNER JOIN user ON user.UserID = peminjaman.UserID INNER JOIN buku ON peminjaman.BukuID = buku.BukuID WHERE StatusPeminjaman='dikembalikan' ORDER BY TanggalPengembalian DESC");
                                }
                                $no = 1;
