                        ...
                        <table class="table table-bordered">
                            ...
                            <form action="" method="post" class="mt-5">
                                <div class="input-group d-flex justify-content-around mb-3">
                                    ...
                                    <div>
                                        <a href="pinjamBuku.php" class="btn btn-success"><i class="fas fa-book"></i> Pinjam Buku</a>
                                    </div>
                                    <div>
                            ...
                            <tbody>
                                ...
                                if (isset($_POST['search'])) {
                                    ...
                                    $member = mysqli_query($koneksi, "SELECT * FROM peminjaman INNER JOIN user ON user.UserID = peminjaman.UserID INNER JOIN buku ON buku.BukuID = peminjaman.BukuID WHERE
